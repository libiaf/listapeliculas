...
class PeliculaRepositorio {
    ...
    fun getPeliculas(): List<Pelicula>{
        return listOf(
            Pelicula(1,"Clueless","Comedia","1h 37min", "Cher y Dionne son dos de las chicas más populares de una escuela secundaria de Beverly Hills. Su máxima preocupación es llevar la ropa más atractiva y ser tan populares como sea posible. Pero a pesar de su apariencia, Cher tiene un gran corazón."),
            ...
            Pelicula(4,"KPop Demon Hunters","Animación","1h 39min", "Un supergrupo de k-pop usa sus poderes secretos para proteger a sus fans de amenazas sobrenaturales y de una banda rival de chicos decididos a robar corazones y mentes."),
